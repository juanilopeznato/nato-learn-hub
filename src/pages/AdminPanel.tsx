                ...
                <tbody className="divide-y divide-gray-100">
                  {allCourses?.map(c => (
                    <tr key={c.id} className="hover:bg-secondary/30 transition-colors">
                      ...
                      <td className="px-4 py-3 text-muted-foreground text-xs">{c.profiles?.full_name ?? '—'}</td>
                ...
                <tbody className="divide-y divide-gray-100">
                  {recentEnrollments?.map(e => (
                    <tr key={e.id} className="hover:bg-secondary/30 transition-colors">
                      <td className="px-4 py-3">
                        <p className="font-medium text-foreground text-xs">{e.profiles?.full_name ?? '—'}</p>
                        <p className="text-muted-foreground/80 text-xs">{e.profiles?.email ?? ''}</p>
                      </td>
                      <td className="px-4 py-3 text-muted-foreground text-xs">{e.courses?.title ?? '—'}</td>
                      <td className="px-4 py-3">
