...
const STEPS = [
  {
    ...
    description: 'Explorá el catálogo y encontrá el tema que querés dominar. Desde cero o nivel avanzado.',
    color: 'text-primary',
    bg: 'bg-primary/10',
  ...
  },
  {
    ...
    description: 'Avanzá lección por lección cuando quieras. Guardamos tu progreso automáticamente.',
    color: 'text-accent',
    bg: 'bg-accent/10',
  ...
  },
  {
    ...
    description: 'Al completar el curso, recibís un certificado verificable que podés compartir en cualquier red.',
